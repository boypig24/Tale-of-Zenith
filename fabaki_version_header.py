...
TEXTURE_TELESHROOM = load_texture(TEXTURE_TELESHROOM_NAME)
...
for song in SOUND_BACKGROUND_NAMES:
    BACKGROUND_SONGS.append(pygame.mixer.Sound(f"{SOUND_PATH}\\{song}.{SOUND_FILE_EXT}"))

SOUND_TING = pygame.mixer.Sound(f"{SOUND_PATH}\\{SOUND_TING_NAME}.{SOUND_FILE_EXT}")
...
EFFECT_TELESHROOM_ANIMATION_DURATION = 25
EFFECT_SLIME_SCORE = 1
EFFECT_GOLDEN_SLIME_SCORE = 10
