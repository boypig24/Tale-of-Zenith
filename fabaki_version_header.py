...
SOUND_BACKGROUND1_NAME = "background"
SOUND_BACKGROUND2_NAME = "stargazer"
BACKGROUND_SONGS = [pygame.mixer.Sound(f"{SOUND_PATH}\\{SOUND_BACKGROUND1_NAME}.{SOUND_FILE_EXT}"),
                    pygame.mixer.Sound(f"{SOUND_PATH}\\{SOUND_BACKGROUND2_NAME}.{SOUND_FILE_EXT}")]
